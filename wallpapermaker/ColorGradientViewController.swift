...
class ColorGradientViewController: UIViewController {
    ...
    func setGradientLayer() {
        ...
        hueGradientLayer.colors = [
            UIColor(hue: 0, saturation: 1.0, brightness: CGFloat(brightnessPicker.value) / 100, alpha: 1).cgColor,
            UIColor(hue: 0.17, saturation: 1.0, brightness: CGFloat(brightnessPicker.value) / 100, alpha: 1).cgColor,
            UIColor(hue: 0.33, saturation: 1.0, brightness: CGFloat(brightnessPicker.value) / 100, alpha: 1).cgColor,
            UIColor(hue: 0.5, saturation: 1.0, brightness: CGFloat(brightnessPicker.value) / 100, alpha: 1).cgColor,
            UIColor(hue: 0.67, saturation: 1.0, brightness: CGFloat(brightnessPicker.value) / 100, alpha: 1).cgColor,
            UIColor(hue: 0.83, saturation: 1.0, brightness: CGFloat(brightnessPicker.value) / 100, alpha: 1).cgColor,
            UIColor(hue: 1, saturation: 1.0, brightness: CGFloat(brightnessPicker.value) / 100, alpha: 1).cgColor,
        ]
    }
